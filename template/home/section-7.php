...
<section class="shila_section">
    <div class="shila_section_title">
        <span class="this_title"><?php echo get_option('shila_sec_7'); ?></span>
    </div>
    <div class="grid_2">
        <?php $shila_sec_7 = new Wp_Query( array(
            'posts_per_page' => '2',
            'category_name' => get_option('shila_sec_7'),
        )); $count=0; ?>
        <?php while($shila_sec_7->have_posts()) : $shila_sec_7->the_post(); ?>
    ...
    <div class="grid_4">
        ...
        <?php while($shila_sec_7->have_posts()) : $shila_sec_7->the_post(); $count++; ?>
