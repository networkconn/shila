...
<section class="shila_section">
    <div class="shila_section_title">
        <span class="this_title"><?php echo get_option('shila_sec_6'); ?></span>
    </div>
    <div class="grid_3">
        <div class="grid_3A">
            <?php $shila_sec_6 = new Wp_Query( array(
                'posts_per_page' => '3',
                'category_name' => get_option('shila_sec_6'),
            )); $count=0; ?>
            <?php while($shila_sec_6->have_posts()) : $shila_sec_6->the_post(); $count++; ?>
