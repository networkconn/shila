...
<form action="" method="post" class="sila_front">
    <table>
        <tbody>
            <tr>
                <td><label for="shila_hero">Hero Active?</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_1">Section 1</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_2">Section 2</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_3">Section 3</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_4">Section 4</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_5">Section 5</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_6">Section 6</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_7">Section 7</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_8">Section 8</label></td>
                <td>
            ...
            <tr>
                <td><label for="shila_sec_9">Section 9</label></td>
                <td>
